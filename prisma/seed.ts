    ...
    const faqs = [
        {
            ...
            answerEn:
                '<p>We offer a comprehensive range of services including executive protection, residential security, event security, security consulting, close protection training, and counter-surveillance.</p>',
            answerFa:
                '<p>ما طیف کاملی از خدمات شامل حفاظت از مدیران، امنیت منازل، امنیت رویدادها، مشاوره امنیتی، آموزش حفاظت نزدیک و ضد نظارت را ارائه می‌دهیم.</p>',
            answerAr:
                '<p>نقدم مجموعة شاملة من الخدمات بما في ذلك حماية التنفيذيين والأمن السكني وأمن الفعاليات والاستشارات الأمنية والتدريب على الحماية القريبة ومكافحة المراقبة.</p>',
            category: 'general',
            order: 1,
            published: true,
        },
        {
            ...
            answerEn:
                '<p>Yes, all our personnel are fully licensed and insured. We hold all necessary permits including firearm carry licenses, non-lethal weapon permits, and private security company licenses.</p>',
            answerFa:
                '<p>بله، تمام پرسنل ما دارای مجوز کامل و بیمه هستند. ما دارای کلیه مجوزهای لازم از جمله مجوز حمل سلاح گرم، مجوز حمل گاز و مجوز تأسیس شرکت امنیتی خصوصی هستیم.</p>',
            answerAr:
                '<p>نعم، جميع أفرادنا مرخصون ومؤمن عليهم بالكامل. لدينا جميع التراخيص اللازمة بما في ذلك تراخيص حمل الأسلحة النارية وتصاريح الأسلحة غير القاتلة وتراخيص شركات الأمن الخاصة.</p>',
            category: 'security',
            order: 2,
            published: true,
        },
