...
export default async function ServicesPage() {
    ...
    // Fetch all published services, ordered by order field
    ...
    const getLocalizedTitle = (service: LocalizedFields) => {
    ...
    const getLocalizedDescription = (
        service: Pick<LocalizedFields, 'descriptionEn' | 'descriptionFa' | 'descriptionAr'>
    ) => {
