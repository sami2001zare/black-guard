...
// }
  ...
  const title =
    locale === 'fa' ? about.titleFa :
    locale === 'ar' ? about.titleAr :
    about.titleEn;

  const content =
    locale === 'fa' ? about.contentFa :
    locale === 'ar' ? about.contentAr :
    about.contentEn;

  const isRtl = locale === 'fa' || locale === 'ar';

  return (
    <div className="bg-black text-white min-h-screen py-16 md:py-24" dir={isRtl ? 'rtl' : 'ltr'}>
