        ...
        <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
          <table className="w-full text-sm">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                <th className="text-right p-3 font-medium text-gray-600">سوال (EN)</th>
                <th className="text-right p-3 font-medium text-gray-600">سوال (FA)</th>
                <th className="text-right p-3 font-medium text-gray-600">دسته‌بندی</th>
                ...
                <tr key={faq.id} className="border-b border-gray-100 hover:bg-gray-50">
                  ...
                  <td className="p-3">
                    <span className={`px-2 py-1 rounded-full text-xs ${
                      faq.published ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-500'
                    }`}>
