...
export default function ImagePickerDialog({ open, onClose, onSelect, selectedId }: ImagePickerDialogProps) {
        ...
        <div className="flex-1 overflow-y-auto">
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-sm text-gray-400">لطفاً ابتدا تصویر را در گالری آپلود کنید.</p>
            </div>
          ) : (
                ...
                >
                  ...
                  {selectedId === item.id && (
                    <div className="absolute inset-0 bg-blue-500/20 flex items-center justify-center">
                      <span className="bg-blue-500 text-white text-xs font-bold px-2 py-1 rounded-full">✓</span>
                    </div>
                  )}
                </div>
              ))}
