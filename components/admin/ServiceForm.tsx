...
export default function ServiceForm({ id, initialData }: ServiceFormProps) {
  ...
  const handleDescriptionChange = (field: 'descriptionEn' | 'descriptionFa' | 'descriptionAr') => (html: string) => {
        ...
        <div className="grid grid-cols-1 gap-4">
          <div>
            ...
            <input
              ...
              required
            />
            <label className="block text-sm font-medium text-gray-700 mb-1 mt-4">توضیحات انگلیسی</label>
            <TextEditor
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            />
            <label className="block text-sm font-medium text-gray-700 mb-1 my-4">توضیحات فارسی</label>
            <TextEditor
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">عنوان عربی</label>
            <input
              type="text"
              name="titleAr"
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            />
            <label className="block text-sm font-medium text-gray-700 mb-1 mt-4">توضیحات عربی</label>
            <TextEditor
        ...
        <div>
          ...
          <div className="flex items-start gap-4">
            ...
            {formData.imageMediaId && (
              <button
                type="button"
                onClick={() => setFormData(prev => ({ ...prev, imageMediaId: '' }))}
