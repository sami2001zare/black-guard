  ...
  return (
    <div className="space-y-3">
      ...
      {loading ? (
        ...
        <p className="text-gray-500 text-sm">هیچ تصویری یافت نشد. لطفاً ابتدا تصویر را در گالری آپلود کنید.</p>
      ) : (
          ...
          {filtered.map((item) => (
            <div
              ...
              className={`relative cursor-pointer border-2 rounded-lg overflow-hidden transition ${
                selectedId === item.id ? 'border-blue-500 ring-2 ring-blue-200' : 'border-transparent hover:border-blue-300'
              }`}
